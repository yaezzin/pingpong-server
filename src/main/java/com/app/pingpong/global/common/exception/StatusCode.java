...
public enum StatusCode {
    ...
    SUCCESS_DELETE_ALL_SEARCH_LOG(true, 200, "검색 기록 전체 삭제에 성공하였습니다.", "SUCCESS_DELETE_ALL_SEARCH_LOG"),
    ...
    INVALID_TEAM_NAME(false, 400, "그룹명은 한글/영문/숫자 10자 이내로 구성되어야 합니다.", "INVALID_TEAM_NAME"),
